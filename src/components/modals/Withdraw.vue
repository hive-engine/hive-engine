<template>
  ...
  >
    ...
    <div v-if="!modalBusy" class="p-6 flex-grow">
      <div class="mb-3">
        In order to withdraw {{ selectedToken }} tokens, you must provide enough {{ evmFeeSymbol }} to cover the network
        gas fee. This reserved fee balance is non-refundable.
      </div>
